...
<div class="divBody">
  ...
  <div class="divCenter">
    <form action="/goods/userAction" method="post" id="regform">
...
<script type="text/javascript"
		src="http://cdn.bootcss.com/jquery/1.12.4/jquery.js"></script>
<script type="text/javascript"
		src="http://cdn.bootcss.com/bootstrap/3.3.7/js/bootstrap.js"></script>
<script type="text/javascript" src="<c:url value='/jsps/js/user/myregist1.js'/>">
