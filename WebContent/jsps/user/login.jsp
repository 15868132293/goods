	...
	<div class="main" style="margin-left: 35%; margin-top: 10%">
		<div class="login1">
			<div class="login2">
				...
				<div>
					<form target="_top" action="<c:url value='/userAction'/>"
						...
						<table>
							...
							<tr>
								...
								<td><input class="input" type="text" name="loginname"
									id="loginname" value="${loginname}" /></td>
							</tr>
							<tr>
								<td height="20">&nbsp;</td>
							...
							<tr>
								...
								<td><input class="input" type="password" name="loginpass"
									id="loginpass"  value='${loginpass}'/></td>
							</tr>
							<tr>
								<td height="20">&nbsp;</td>
							...
							<tr>
								...
								<td><input class="input yzm" type="text" name="verifyCode"
									id="verifyCode" value="" /> 
									<img id="vCode" src="/goods/VerifyCodeServlet" />
									<a id="verifyCode" href="javascript:change()">换张图</a>
								</td>
							</tr>
							<tr>
								<td height="20px">&nbsp;</td>
							...
							<tr>
								...
								<td align="left"><input type="image" id="submit"
									src="<c:url value='/images/login1.jpg'/>" class="loginBtn" /></td>
							</tr>
						</table>
					</form>
				</div>
