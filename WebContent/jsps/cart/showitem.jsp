...
<script type="text/javascript">
  ...
  <body>
<form id="form1" action="/goods/orderAction?flag=submitorder" method="post">
...
<c:forEach items="${cartItemList}" var="cartItem">
	<tr align="center">
		<td align="right">
			<a class="linkImage" href="<c:url value='/jsps/book/desc.jsp'/>"><img border="0" width="54" align="top" src="<c:url value='/${cartItem.book.image_w }'/>"/></a>
		</td>
		<td align="left">
		...
		<td>
			<span class="price_n">&yen;<span class="subtotal" >${cartItem.book.subtotal}</span></span>
		</td>
	</tr>
</c:forEach>
	...
	<tr>
		<td colspan="6">
			<input id="addr" type="text" name="address" value="杭州市 江干区 火车东站 顾家大厦5楼 xxx"/>
		</td>
	</tr>
	<tr>
