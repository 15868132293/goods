...
function delete1(){
	...
	location = "/goods/cartItemAction?flag=deleteduo&cartItemIds=" + cartItemIds;
...
<c:forEach items="${cartItemList}" var="cartItem">
	<tr align="center">
		...
		<td align="left" width="400px">
		    <a href="/goods/cartItemAction?flag=todesc&bid=${cartItem.book.bid}"><span id="bookname">${cartItem.book.bname}</span></a>
		</td>
		...
		<td>
			<a href="cartItemAction?flag=delete&cartItemId=${cartItem.cartItemId}">删除</a>
		</td>
	...
	<tr>
		<td colspan="4" class="tdBatchDelete">
			<a href="javascript:delete1();">批量删除</a>
		</td>
	...
	<tr>
		<td colspan="7" align="right">
			<a href="javascript:tijiao()" id="jiesuan" class="jiesuan"></a>
		</td>
	</tr>

</table>
	<form id="form1" action="/goods/cartItemAction" method="post">
		<input type="hidden" name="cartItemIds" id="cartItemIds"/>
		<input type="hidden" name="flag" value="showItem"/>
	</form>
</c:otherwise>
</c:choose>
  </body>
